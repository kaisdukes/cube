...
public class CubeCompiler {
    ...
    public byte[] compile() {
        ...
        classWriter.visit(
                ...
                "cube/examples/Factorial",
                null,
                "java/lang/Object",
                null);

        classWriter.visitSource("Factorial.java", null);
        emitDefaultConstructor(classWriter);
        emitMethod(classWriter);
        classWriter.visitEnd();

        return classWriter.toByteArray();
    }

    private void emitDefaultConstructor(final ClassWriter classWriter) {
    ...
    private void emitMethod(final ClassWriter classWriter) {
        ...
        methodVisitor.visitFrame(F_SAME1, 0, null, 1, new Object[]{Opcodes.INTEGER});
